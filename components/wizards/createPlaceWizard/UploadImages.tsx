...
export default function UploadImages({ onFinish, placeId }: {
  ...
  return (
    <>
      <AppView withPadding isLoading={isLoading} extraStyles={{ position: 'relative' }}>
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={CommonStyles.dataNotFound}>You haven&#39;t uploaded any images yet, click on

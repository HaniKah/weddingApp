        ...
        <>
            <View style={{padding: 20}}>
                <ScrollView>
                    ...
                    <AppButton fullWidth inactive icon="trash" buttonType={ButtonType.OUTLINED} buttonSize={"MD"}
                               extraStylesBtn={{marginTop: 20}}>
                        medium
                    </AppButton>
                    <AppButton fullWidth inactive icon="trash" buttonType={ButtonType.PRIMARY} buttonSize={"MD"}
                               extraStylesBtn={{marginTop: 20}}>
                        medium
                    </AppButton>
                    <AppButton fullWidth inactive icon="trash" buttonType={ButtonType.PLAIN} buttonSize={"MD"}
                               extraStylesBtn={{marginTop: 20}}>
                        medium
                    </AppButton>

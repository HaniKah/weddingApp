...
export default function AppButton({
    ...
    if (buttonType === ButtonType.OUTLINED) {
        ...
        if (confirmative) {
            buttonStyles = {...buttonStyles, borderColor: Theme.colors.green.S600};
    ...
    //     buttonStyles.paddingVertical = 4;
    // }
    ...
    const handleOnPress = () => {
        ...
        if (isSubmit) {
            formContext.setSubmitting(false); // Reset to false first to ensure transition
            setTimeout(() => {
        ...
        <>
            ...
            >
                <Animated.View style={[buttonStyles, extraStylesBtn]}>
                    ...
                    {icon &&
                        <IconSymbol size={iconSize} color={iconColor || textStyles.color || 'black'} name={icon}/>
                    }
                    {
                        children && <Text style={[textStyles, extraStylesTxt]}>
                            {children}
                        </Text>
                    }
